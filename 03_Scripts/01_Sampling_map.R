...
Soil_types <- st_read("C:/[[ YOUR PATH]]/Cambodian_antagonistic_soils/02_Data/01_Exp_data/Shp_files/Soil_types.shp")

# Contain the coordinates of the sampling sites
Sampling_sites <- read.csv("C:/[[ YOUR PATH]]/Cambodian_antagonistic_soils/02_Data/01_Exp_data/Coordinates_of_sampling_sites.csv.csv", dec = ".", sep = ",", header = TRUE)
